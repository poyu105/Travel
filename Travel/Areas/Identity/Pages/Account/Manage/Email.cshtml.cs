...
namespace Travel.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        private async Task LoadAsync(TravelUser user)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Confirmation link to change email( "+Input.NewEmail+" )sent. Please check your email.";
