...
(3, 'Destination C', '3', '2024-07-01', '2024-07-07', GETDATE(), GETDATE()),
(4, 'Destination D', '1', '2024-08-05', '2024-08-10', GETDATE(), GETDATE()),
...
(3, 'Attraction C', 'Description for Attraction C', 'picture_url_for_attraction_c.jpg', 1, GETDATE(), GETDATE()),
(4, 'Attraction D', 'Description for Attraction D', 'picture_url_for_attraction_d.jpg', 1, GETDATE(), GETDATE()),
(5, 'Attraction E', 'Description for Attraction E', 'picture_url_for_attraction_e.jpg', 1, GETDATE(), GETDATE());
